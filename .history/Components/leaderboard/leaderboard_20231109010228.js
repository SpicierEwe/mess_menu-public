...
function LeaderboardComponent() {
  ...
  function x(meal_menu_data) {
    for (const x in votes_data) {
      const dish_id = votes_data[x];

      for (const week_day_name in menu_data) {
        menu_data[week_day_name].map((meal, index) => {
          if (meal.dish_id == dish_id) {
            console.log("dish_id", dish_id);
            console.log("meal", meal);
            console.log("week_day_name", week_day_name);
