...
const SideMenu = (props) => {
  ...
  const menuStyle = {
    ...
    transition: "transform .5s ease-in-out, opacity .5s ease-in-out", // Use transition for transform and opacity
    position: "fixed",
    top: "0",
    left: "0",
    height: "100vh",
  ...
  return (
    <div>
      <div style={menuStyle}>
        ...
        <Link href="/legal/about_us" style={linkStyle} onClick={closeMenu}>
          About
        </Link>
        <li
          onClick={() => {
