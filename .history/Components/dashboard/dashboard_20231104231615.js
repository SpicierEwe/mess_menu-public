                ...
                return (
                  <div key={meal_type_index}>
                    ...
                    <div className={styles.dishes_container}>
                      {sortedDishes.map(
                        ([highestVotedDishId, ...dishes], meal_type_index) => {
                          return (
                            <div key={meal_type_index}>
                              {/* Heading */}
                              <div className={styles.headings}>
                                ...
                                {dishes.map((dish, index) => {
                                  return (
                                    ...
                                    >
                                      {/* ... (dish details) */}
                                      <div
                                        className={styles.dish_image_container}
                                      >
                                        <Image
                                      ...
                                      <div
                                        className={styles.dish_info_container}
                                      >
                                        {/* DISH NAME */}
                                          ...
                                          <div>
                                            {
                                              <p className={styles.dish_votes}>
                                                {Object.keys(
                                                  global_votes
                                                ).includes(dish.dish_id)
                                                  ? global_votes[dish.dish_id]
                                                      .votes
                                                  : 0}
                                                &nbsp; votes
                                              </p>
