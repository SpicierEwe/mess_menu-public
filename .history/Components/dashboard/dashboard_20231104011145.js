...
function DashboardComponent() {
  ...
  function fetch_menu_data() {
    ...
    if (!meal_table_data[selected_week_day]) {
      console.log("jsujhdvhjsvbdjbsjdbjhb");
      console.log(meal_table_data[selected_week_day]);
      ...
      console.log("DATA EXISTED NOT FECTHING");
      set_meal_table_weekday_data(meal_table_data[selected_week_day]);
    }
  }
