...
function DashboardComponent() {
  ...
  const [selected_week_day, set_selected_week_day] = 
  ...
  const received_data = data[selected_week_day.toLowerCase()];
        ...
        <section className={styles.container_2}>
          ...
          <div className={styles.container_2_sub_main_container}>
            ...
            <div className={styles.headings}>
              <h3>{selected_meal_type}</h3>
              <p>All available dishes</p>
            </div>
            {/* Dishes */}
            <div>{JSON.stringify(received_data)}</div>
          </div>
        </section>
      </main>
    </div>
