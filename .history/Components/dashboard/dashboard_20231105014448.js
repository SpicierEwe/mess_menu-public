          ...
          <div className={styles.container_2_sub_main_container}>
            ...
            <div>
              ...
              {meal_table_weekday_data.map((meal_type, meal_type_index) => {
                // ========================== //
                // find the highest voted dish and put it on top of the list of dishes for each meal type
                let highest_voted_dish = 0;
                let highest_voted_dish_id = "";

                for (const votes in global_votes) {
                  if (global_votes[votes].votes > highest_voted_dish) {
                    highest_voted_dish = global_votes[votes].votes;
                ...
                // holds the rearranged data where the highest voted dish is on top of the list of dishes for each meal type and the rest of the dishes are below it
