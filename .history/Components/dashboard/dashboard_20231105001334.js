                  ...
                  <div key={meal_type_index}>
                    ...
                    <div className={styles.dishes_container}>
                      {meal_type[Object.keys(meal_type)]
                        ...
                        .sort((a, b) => {
                          // Sort the dishes by their votes in descending order
                          const aVotes = global_votes[a.dish_id]?.votes || 0;
                          const bVotes = global_votes[b.dish_id]?.votes || 0;

                          if (aVotes === bVotes) {
                            // If votes are the same, maintain the original order
                            return 0;
                          }
