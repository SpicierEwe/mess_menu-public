...
*/
  ...
  const mealTypeHeadingRefs = [];

  function aa() {
    for (let i = 0; i < meal_types_list.length; i++) {
      mealTypeHeadingRefs.push(useRef(null));
    }
  }
                ...
                <div
                  onClick={() => {
                    ...
                    const scrollPosition =
                      mealTypeHeadingRefs[index].current.offsetTop - 50; // Adjust the margin as needed
