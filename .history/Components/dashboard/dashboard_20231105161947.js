        ...
        <section className={styles.container_2}>
          ...
          <div className={styles.container_2_sub_main_container}>
            ...
            <div>
              ...
              {meal_table_weekday_data.map(
                (meal_type_data, meal_type_index) => {
                  // ========================== //
                  // find the highest voted dish and put it on the front of the list of dishes for each meal type
                  const mealTypeName = Object.keys(meal_type_data);

                  // Find the highest voted dish for this meal type
                  const highestVotedDishId =
                    findHighestVotedDish(meal_type_data);

                  const x = meal_type_data[mealTypeName];
                  ...
                  return (
                    <div key={meal_type_index}>
                      ...
                      <div className={styles.headings}>
                        <h3>{Object.keys(meal_type_data)}</h3>
                              ...
                              >
                                <div className={styles.dish_image_container}>
                                  ...
                                  <div className={styles.banner_container}>
                                    ...
                                    {highlight_voted_dish(dish.dish_id) && (
                                      <div
                                        className={styles.banner_your_choice}
                                      >
                                        YOUR CHOICE
                                      </div>
                                    )}
