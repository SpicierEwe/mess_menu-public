          ...
          <div className={styles.container_2_sub_main_container}>
            ...
            <div>
              ...
              {meal_table_weekday_data.map((meal_type, meal_type_index) => {
                ...
                const highestVotedDish = meal_type[
                  Object.keys(meal_type)
                ].reduce((prev, current) => {
                ...
                return (
                  <div key={meal_type_index}>
                    ...
                    {/* Dishes display ===== PART 1 ===== */}
                    <div>
                      <div className={styles.dishes_container}>
                        {[highestVotedDish].map((dish, index) => {
                          return (
                            // display the highest rated dish
                              ...
                              {dish && (
                                ...
                                >
                                  ...
                                  <div className={styles.dish_info_container}>
                                    ...
                                    <div
                                      className={styles.dish_votes_container}
                                    >
                                      {/* DISH VOTES */}
                                      <div>
                      ...
                      {/* Dishes display ===== PART 2 ===== */}
                      <div className={styles.dishes_container}>
                        {meal_type[Object.keys(meal_type)].map(
                          (dish, index) => {
                            if (dish.dish_id !== highestVotedDish?.dish_id) {
                              return (
                                // display the highest rated dish

                                <div key={index}>
                                  {dish !== highestVotedDish && (
                                    <div
                                      onClick={() => {
                                        vote(
                                          dish.dish_id,
