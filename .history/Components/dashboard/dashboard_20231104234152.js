          ...
          <div className={styles.container_2_sub_main_container}>
            ...
            <div>
              ...
              {meal_table_weekday_data.map((meal_type, meal_type_index) => {
                ...
                global_votes.map((dish, index) => {
                  if (dish.votes > high_votes) {
                    high_votes = dish.votes;
                    most_voted_dish_id = Object.keys(global_votes[index]);
                  }
                });
                ...
                //     console.log("found");
                //     most_voted_dish_id = dish.dish_id;
                //   } else {
                //     most_voted_dish_id = "not found";
                //   }
                // });
                return (
