...
function LoginPage() {
  return (
    <div className={styles.top_parent_container}>
      {/* ONLY DIPLAYED FOR DESKTOPS */}
      {window.innerWidth < 768 ? (  <div className={styles.art_work_container}>
        <Image
          className={styles.art_work_style}
          src="/images/login_page_images/art_work_desktop.svg"
          alt="login_page"
          width={1500}
          height={1500}
        ></Image>
